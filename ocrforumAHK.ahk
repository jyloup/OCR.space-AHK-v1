; AHK code by Jyloup, november 2025
; working example of using OCR.space API with autohotkey v1 language
; topic: https://www.autohotkey.com/boards/viewtopic.php?t=24884&p=117844

#Include json.ahk

oForm := { apikey: "helloworld"
         , language: "fre"
	    , OCREngine: "2"
         ;, file: ["08-15b.jpg"] ; uncomment this line to get text from local image (comment following line)
	    , url: "https://filedn.eu/lrEr3PMxOiqLH2E5XbvrH3f/2025-05-31%20sam%20seraing/08-15b.jpg"}
